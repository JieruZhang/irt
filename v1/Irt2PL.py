...
class Irt2PL(BaseIrt):
    ...
    # EM算法求解
    def __init__(self, init_slop=None, init_threshold=None, max_iter=100000, tol=1e-5, gp_size=11, *args, **kwargs):
        """
    ...
    def _m_step(self, p_val, full_dis, right_dis, slop, threshold, theta):
        # EM算法M步
        return self._irls(p_val, full_dis, right_dis, slop, threshold, theta)
